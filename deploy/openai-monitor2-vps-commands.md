...
business.panqda.com  business.panqda.com
...
curl -fsSL https://raw.githubusercontent.com/ppanjinfeng-afk/openai-monitor2/main/deploy/bootstrap-ubuntu.sh \
  | sudo env \
      ...
      CERTBOT_DOMAINS='xn--2team-cd2h.com,www.xn--2team-cd2h.com,business.panqda.com,business.xn--2team-cd2h.com,activate.xn--2team-cd2h.com,admin.xn--2team-cd2h.com' \
...
```bash
sudo certbot --nginx -d business.panqda.com -d business.xn--2team-cd2h.com --redirect
sudo systemctl reload nginx
```
...
```text
独立项目选择站：https://business.panqda.com/
2人席位账号：https://business.2人team.com/
