...
curl -fsSL https://raw.githubusercontent.com/ppanjinfeng-afk/openai-monitor2/main/deploy/bootstrap-ubuntu.sh \
  | sudo env \
      ...
      CERTBOT_DOMAINS='xn--2team-cd2h.com,www.xn--2team-cd2h.com,business.panqda.com,activate.xn--2team-cd2h.com,admin.xn--2team-cd2h.com' \
...
```bash
sudo certbot --nginx -d business.panqda.com --redirect
sudo systemctl reload nginx
```
...
sudo nginx -t
sudo certbot --nginx --non-interactive --agree-tos --redirect --register-unsafely-without-email -d xn--2team-cd2h.com -d www.xn--2team-cd2h.com -d business.panqda.com
